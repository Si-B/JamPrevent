...
public interface JamPreventVocabulary {
    ...
    public static final String TRAFFIC_LIGHT_LOCATION_AND_DIRECTION_CROSSLOCATION = "crossLocation";
    ...
    public static final String TRAFFIC_LIGHT_PROPERTIES_CROSSLOCATION = "crossLocation";
